    ...
    <ul class="widget widget-menu unstyled">
      <li>
        <a class="collapsed" data-toggle="collapse" href="#togglePages">
          ...
          <i class="icon-chevron-down pull-right">
          </i>
...
{?>
    ...
    <ul class="widget widget-menu unstyled">
      ...
      <li>
        <a href="logout.php">
          <i class="menu-icon icon-signout">
          </i>
          Logout
        </a>
      </li>
